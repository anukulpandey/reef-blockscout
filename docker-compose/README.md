...
- The local compose file defaults `FRONTEND_PORT` to `3009`. Override it if you want a different fixed local port, and if Dokploy accidentally uses this file it will bind to `3009` instead of colliding with something already on `3000`.
